                ...
                <div className="flex gap-4 justify-end mt-6">
                  ...
                  >
                    Save to Database
                      ...
                      className={cn(
                        ...
                        ocrData.studentName.lowConfidence ? "border-amber-300" : "border-card-border"
                      )}
                    />
                    {ocrData.studentName.lowConfidence && (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={cn(
                        "w-full h-12 bg-slate-50 border rounded-xl px-4 font-semibold outline-none focus:ring-2 focus:ring-primary/20",
                        ocrData.dateOfBirth.lowConfidence ? "border-amber-300" : "border-card-border"
                      )}
                    />
                    {ocrData.dateOfBirth.lowConfidence && (
                      <p className="text-xs text-amber-600 mt-1 flex items-center gap-1"><AlertCircle size={12} /> Low confidence</p>
                    )}
                  </div>
                  <div>
                    ...
                    <select
                      ...
                      className={cn(
                        "w-full h-12 bg-slate-50 border rounded-xl px-4 font-semibold outline-none focus:ring-2 focus:ring-primary/20",
                        ocrData.gender.lowConfidence ? "border-amber-300" : "border-card-border"
                      )}
                    >
                      <option value="">Select Gender</option>
                      <option value="Male">Male</option>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={cn(
                        "w-full h-12 bg-slate-50 border rounded-xl px-4 font-semibold outline-none focus:ring-2 focus:ring-primary/20",
                        ocrData.contactNumber.lowConfidence ? "border-amber-300" : "border-card-border"
                      )}
                    />
                    {ocrData.contactNumber.lowConfidence && (
                      <p className="text-xs text-amber-600 mt-1 flex items-center gap-1"><AlertCircle size={12} /> Low confidence</p>
                    )}
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={cn(
                        "w-full h-12 bg-slate-50 border rounded-xl px-4 font-semibold outline-none focus:ring-2 focus:ring-primary/20",
                        ocrData.dateEnrolled.lowConfidence ? "border-amber-300" : "border-card-border"
                      )}
                    />
                    {ocrData.dateEnrolled.lowConfidence && (
                      <p className="text-xs text-amber-600 mt-1 flex items-center gap-1"><AlertCircle size={12} /> Low confidence</p>
                    )}
                  </div>
                </div>
